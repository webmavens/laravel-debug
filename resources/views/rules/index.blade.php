                    ...
                    <table class="relative min-w-full divide-y divide-gray-300 dark:divide-white/15">
                        <thead class="bg-white dark:bg-gray-800/75">
                            <tr>
                                ...
                                <th scope="col"
                                    class="relative px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-200">
                                ...
                                <th scope="col"
                                    class="py-3.5 pr-4 pl-3 text-sm font-semibold text-gray-900 dark:text-gray-200 text-right sm:pr-6">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200 bg-white dark:divide-white/10 dark:bg-gray-800/50">
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                                    <span
                                        class="inline-flex items-center rounded-md bg-green-100 px-2 py-1 text-xs font-medium text-green-700 dark:bg-green-400/10 dark:text-green-400">{{ ucfirst($rule->status) }}</span>
                                </td>
                                <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
